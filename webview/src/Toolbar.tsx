...
export function Toolbar({
  ...
  return (
    ...
    >
      ...
      <div
        className="shrink-0"
        style={{ height: '18px', width: 'auto', opacity: 0.9, display: 'flex', alignItems: 'center', filter: 'brightness(0) invert(1)' }}
      ...
      >
        {pinsVisible ? (
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="white" viewBox="0 0 16 16" opacity="0.4">
